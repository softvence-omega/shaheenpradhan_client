...
const AssistantDashboardNavbar = () => {
  return (
    <div className="flex border border-neutral-200 flex-col sm:flex-row sm:items-center justify-between p-[6px]">
      ...
      {/* FOR SMALL DEVICE ONLY - Only show logo and bell icon */}
      ...
      {/* SEARCH FIELD - Hidden on mobile, visible on sm and up */}
      <div className="hidden sm:block p-1 w-full sm:max-w-[450px]">
      ...
      {/* NOTIFICATION SECTION - Hidden on mobile, visible on sm and up */}
