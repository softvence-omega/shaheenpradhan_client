    ...
    >
      <Wrapper>
        <div>
          ...
          {/* SECOND DIV */}
          <div className="flex flex-col sm:flex-row pt-5 justify-between gap-6 px-2 xl:px-0 w-full">
            {/* ROBOT SECTION */}
            <div className="flex flex-col  sm:pt-12 w-full sm:w-auto">
              <Robot className="shadow-2xl shadow-ButtonBGPrimary rounded-full w-16 sm:w-20" />
            ...
            {/* AVATAR CARD */}
            <div className="w-[60%] mx-auto sm:mx-0 lg:w-[30%] flex flex-col items-center text-center space-y-4 backdrop-blur-md p-6 rounded-md border border-gray-50/65">
              <AnimatedTooltip items={items} />
              <p className="font-light text-xs sm:text-sm text-white hidden sm:block">
