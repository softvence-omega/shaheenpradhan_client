...
import WorkPrefer from "@/components/assistant/WorkPrefer";
...
const WorkPreference: React.FC<WorkPreferenceProps> = ({
  onNext,
  onBack,
  data,
  updateData,
  ...
  const [availableDays, setAvailableDays] = useState(
    data.availableDays || ["Sun", "Mon", "Tue", "Wed", "Thu"]
  );
            ...
            {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
              ...
              >
                <input
                  ...
                  className="accent-[#8559CA] w-[18px] h-[18px] cursor-pointer"
                />
                {day}
              </label>
            ))}
