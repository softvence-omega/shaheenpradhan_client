...
import Male from "@/assets/images/malePhoto.png";
  ...
  return (
    <Wrapper>
      <div className="pt-20 flex flex-col md:flex-row justify-between">
        <section className="space-y-5 max-w-1/2 w-full">
          <TitleAndSubTitle
        ...
        <section className="flex items-center gap-5 max-w-1/3 w-full justify-between">
          <img
            src={Male}
            alt="male"
            className="border-[2px] border-white p-1 rounded-xl h-80 md:h-fit"
          />
          <img src={Female} alt="female" className="h-80 md:h-fit" />
        </section>
      </div>
    </Wrapper>
  );
